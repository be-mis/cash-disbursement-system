...
const RequestCreationForms: React.FC<RequestFormProps> = ({ 
  ...
  const [advanceData, setAdvanceData] = useState<Partial<CreateCashAdvanceDto>>({
    employeeId: currentUser.id,
    estimatedAmount: undefined,  // CHANGED
    category: 'Travel',
    description: '',
    plannedExpenseDate: '',
    advancePurpose: '',
  ...
  const [liquidationData, setLiquidationData] = useState<Partial<CreateLiquidationDto>>({
    advanceId: '',
    actualAmount: undefined,  // CHANGED
    description: '',
    liquidationSummary: '',
    attachments: [],
    varianceExplanation: '',
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) => setReimbursementData({...reimbursementData, amount: e.target.value ? parseFloat(e.target.value) : undefined})} // CHANGED
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) => setAdvanceData({...advanceData, estimatedAmount: e.target.value ? parseFloat(e.target.value) : undefined})} // CHANGED
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => setLiquidationData({...liquidationData, actualAmount: e.target.value ? parseFloat(e.target.value) : undefined})} // CHANGED
